...
def main():
    ...
    square_boundary = [ [0,0], [1,0], [1,1], [0,1] ]
    holes_boundary = [[ [0.25, 0.24], [0.75, 0.25], [0.75, 0.75], [0.25, 0.75] ]]

    min_distance = 0.02
    
    node_coords, elem2nodes, node2elems, node2nodes, p_node2nodes = generate_mesh(square_boundary, holes_boundary, min_distance, verbose=2)
